...
if ~isfile(videoPath)
    ...
    while hasFrame(videoObj)
        ...
        if mod(frameCount, 5) == 0
            ...
            % 5. 计算连通区域属性
            stats = regionprops(enhancedEdges, 'BoundingBox', 'MajorAxisLength', 'Area', 'PixelIdxList', 'Eccentricity');
            ...
            for i = 1:length(stats)
                ...
                if area > minAreaThreshold && majorLength > minLengthThreshold && eccentricity > minEccentricity
